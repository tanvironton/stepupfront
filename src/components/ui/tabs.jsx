...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "flex items-center h-9 justify-center rounded-lg text-muted-foreground",
      className
    )}
    {...props}
  />
